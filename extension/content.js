...
//     let listName = tdom.getListName(el);
...
//     // FIXME Might want to call countListLabels instead
//     let labels = tdom.getCardLabels(el, ["*", "concern"]);
...
//     roleConstraints = tdom.getCardLabels(el);
...
//     }
//     let listName = tdom.getListName(el);
//     if (listName === "Squadification Constraints" || listName.indexOf("*") > -1) {
//         return;
//     }
...
//     violationsEl.empty();
//     var teamRoles = tdom.getCardLabels(el);
